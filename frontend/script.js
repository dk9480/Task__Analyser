...
//     if (!jsonInput) {
//         resultsDiv.innerHTML = '<div class="error">Please enter tasks in JSON format</div>';
//         return;
//     }
...
//     try {
//         const response = await fetch('http://localhost:8000/api/tasks/suggest/');
//         const data = await response.json();
...
//             <div class="task-item">
//                 <h3>${task.title}</h3>
//                 <div><strong>Priority Score:</strong> ${task.priority_score}</div>
//                 <div><strong>Due:</strong> ${task.due_date}</div>
//                 <div><strong>Effort:</strong> ${task.estimated_hours} hours</div>
...
//                 <div><strong>Score:</strong> ${task.priority_score}</div>
//                 <div><strong>Why:</strong> ${task.explanation}</div>
//             </div>
//         `;
//     });
